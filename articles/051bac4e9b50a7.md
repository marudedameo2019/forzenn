...
LaravelもPHPなので、printfやらechoやらしてしまえばどこでもそのままHTMLを返せるのですが、普通はLaravel
の作法に則ってHTMLを返します。Laravelの昔ながらの標準的な方法は以下になります。
...
詳細はデバイスごとに違う可能性があるのでここでは説明しません。しかしこの方法が一番正当な方法です。
