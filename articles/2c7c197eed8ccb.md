...
このコードは短いのですぐにどこに問題があるか分かりますが、通信処理など待ち合わせの多いプログラムを書いていると、どこで非同期処理が動いているのか長くなると把握しにくくなるものです。自分で書いたものならともかく最近だと他人やAIが書いたコードを読むことなども多いと思います。そんなときどうやってasync/awaitなどで並行して動作している処理を把握すればいいのでしょうか？
